...
class Interceptor extends \Dotdigitalgroup\Email\Model\ResourceModel\Contact\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getContactsToImportForWebsite');
        return $pluginInfo ? $this->___callPlugins('getContactsToImportForWebsite', func_get_args(), $pluginInfo) : parent::getContactsToImportForWebsite($websiteId, $pageSize);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMissingContacts');
        return $pluginInfo ? $this->___callPlugins('getMissingContacts', func_get_args(), $pluginInfo) : parent::getMissingContacts($websiteId, $pageSize);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'loadByCustomerEmail');
        return $pluginInfo ? $this->___callPlugins('loadByCustomerEmail', func_get_args(), $pluginInfo) : parent::loadByCustomerEmail($email, $websiteId);
    }

    /**
     * {@inheritdoc}
     */
    public function getSubscribersToImport($storeId, $limit = 1000, $isCustomerCheck = true)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSubscribersToImport');
        return $pluginInfo ? $this->___callPlugins('getSubscribersToImport', func_get_args(), $pluginInfo) : parent::getSubscribersToImport($storeId, $limit, $isCustomerCheck);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSubscribersToImportFromEmails');
        return $pluginInfo ? $this->___callPlugins('getSubscribersToImportFromEmails', func_get_args(), $pluginInfo) : parent::getSubscribersToImportFromEmails($emails, $storeId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getGuests');
        return $pluginInfo ? $this->___callPlugins('getGuests', func_get_args(), $pluginInfo) : parent::getGuests($websiteId, $onlySubscriber);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getNumberOfImportedContacts');
        return $pluginInfo ? $this->___callPlugins('getNumberOfImportedContacts', func_get_args(), $pluginInfo) : parent::getNumberOfImportedContacts();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getNumberCustomerContacts');
        return $pluginInfo ? $this->___callPlugins('getNumberCustomerContacts', func_get_args(), $pluginInfo) : parent::getNumberCustomerContacts($websiteId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getNumberCustomerSuppressed');
        return $pluginInfo ? $this->___callPlugins('getNumberCustomerSuppressed', func_get_args(), $pluginInfo) : parent::getNumberCustomerSuppressed($websiteId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getNumberCustomerSynced');
        return $pluginInfo ? $this->___callPlugins('getNumberCustomerSynced', func_get_args(), $pluginInfo) : parent::getNumberCustomerSynced($websiteId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getNumberSubscribersSynced');
        return $pluginInfo ? $this->___callPlugins('getNumberSubscribersSynced', func_get_args(), $pluginInfo) : parent::getNumberSubscribersSynced($websiteId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getNumberSubscribers');
        return $pluginInfo ? $this->___callPlugins('getNumberSubscribers', func_get_args(), $pluginInfo) : parent::getNumberSubscribers($websiteId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSubscriberDataByEmails');
        return $pluginInfo ? $this->___callPlugins('getSubscriberDataByEmails', func_get_args(), $pluginInfo) : parent::getSubscriberDataByEmails($emails);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getContactsToImportByWebsite');
        return $pluginInfo ? $this->___callPlugins('getContactsToImportByWebsite', func_get_args(), $pluginInfo) : parent::getContactsToImportByWebsite($websiteId, $syncLimit, $onlySubscriber);
    }
