...
class Interceptor extends \Dotdigitalgroup\Email\Model\ResourceModel\Wishlist\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'joinLeftCustomer');
        return $pluginInfo ? $this->___callPlugins('joinLeftCustomer', func_get_args(), $pluginInfo) : parent::joinLeftCustomer();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getWishlistToImportByWebsite');
        return $pluginInfo ? $this->___callPlugins('getWishlistToImportByWebsite', func_get_args(), $pluginInfo) : parent::getWishlistToImportByWebsite($website, $limit);
    }

    /**
     * {@inheritdoc}
     */
    public function getModifiedWishlistToImportByWebsite(\Magento\Store\Api\Data\WebsiteInterface $website, $limit = 100)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getModifiedWishlistToImportByWebsite');
        return $pluginInfo ? $this->___callPlugins('getModifiedWishlistToImportByWebsite', func_get_args(), $pluginInfo) : parent::getModifiedWishlistToImportByWebsite($website, $limit);
    }
